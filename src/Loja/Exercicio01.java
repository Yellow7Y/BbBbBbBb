...
public class Exercicio01 {
    public static void main(String[] args) {
        ...
        estoque.nome = "RTX 3090 TI";
        estoque.quantidadeEstoque = 9;
        exibirQuantidadeEmEstoque(estoque);
    }

    private static void exibirQuantidadeEmEstoque(Estoque estoque) {
        Boolean temEstoque = estoque.quantidadeEstoque < 10;
        if (temEstoque) {
            System.out.println("O PRODUTO " + estoque.nome + " ESTÁ ABAIXO DO ESTOQUE, POR FAVOR, REPONHA A MERCADORIA!");
        } else {
            System.out.println("O PRODUTO " + estoque.nome + " ESTÁ ACIMA DO ESTOQUE, NÃO PRECISA REPOR A MERCADORIA!");
        }
    }
}